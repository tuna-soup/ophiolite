...
- `docs/architecture/ADR-0014-seismic-crs-native-effective-display-boundary.md`
- `docs/architecture/ADR-0015-authored-models-compiled-runtime-assets-and-display-dtos.md`
- `docs/architecture/ADR-0016-canonical-wellbore-geometry-and-resolved-trajectory-boundary.md`
- `docs/architecture/ADR-0017-well-time-depth-source-assets-authored-models-and-compiled-runtime-output.md`
- `docs/architecture/ADR-0018-project-aware-well-on-section-overlay-dtos-and-backend-projection-rules.md`
- `docs/architecture/ADR-0019-chart-kernels-rock-physics-crossplot-and-point-cloud-spike.md`
- `docs/architecture/ADR-0020-avo-chart-family-analysis-contracts-and-initial-rendering-plan.md`
- `docs/architecture/ADR-0021-volume-interpretation-chart-family-and-resolved-scene-boundary.md`
- `docs/architecture/ADR-0022-canonical-well-and-wellbore-metadata-phase-one.md`
- `docs/architecture/ADR-0023-canonical-well-markers-phase-one.md`
- `docs/architecture/ADR-0024-authored-marker-set-assets-and-canonical-marker-precedence.md`
- `docs/architecture/ADR-0025-well-marker-depth-horizon-residuals.md`
- `docs/architecture/ADR-0026-vendor-project-import-adapters.md`
- `docs/architecture/ADR-0027-asset-owner-scopes-for-vendor-and-survey-assets.md`
- `docs/architecture/ADR-0028-domain-first-python-sdk-surface-and-advanced-namespaces.md`
- `docs/architecture/ADR-0029-unified-import-manager-and-provider-registry.md`
