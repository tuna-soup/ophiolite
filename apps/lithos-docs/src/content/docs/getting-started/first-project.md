---
title: First Project
description: Work with multiple linked wellbore asset families under LithosProject.
draft: false
---

`LithosProject` is the multi-asset entry point above individual packages.
...
fn main() -> Result<(), lithos_las::LasError> {
    let project = LithosProject::open("test_data/projects/synthetic_well_project")?;
...
- [LithosProject](/packages-and-projects/lithos-project/)
