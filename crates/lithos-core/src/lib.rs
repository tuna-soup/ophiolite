...
pub use dto::{
    ...
    HeaderItemUpdate, MetadataDto, MetadataSectionDto, MetadataUpdateRequest, PackageId,
    PackagePathRequest, RevisionToken, SaveConflictDto, SavePackageResultDto,
    SaveSessionResponseDto, SessionContextDto, SessionCurveEditRequest, SessionId,
    ...
    dirty_state_dto, metadata_dto, package_id_for_path, package_validation_report,
    ...
    validate_edit_state, validation_report_dto,
};
pub use metadata::{
