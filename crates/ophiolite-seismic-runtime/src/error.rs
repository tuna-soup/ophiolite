...
pub enum SeismicStoreError {
    ...
    #[error("{0}")]
    SeisIoInspect(#[from] ophiolite_seismic_io::InspectError),
    #[error("{0}")]
    SeisIoRead(#[from] ophiolite_seismic_io::ReadError),
    #[error("{0}")]
    ...
    UnsupportedSurveyGeometry {
        classification: ophiolite_seismic_io::GeometryClassification,
